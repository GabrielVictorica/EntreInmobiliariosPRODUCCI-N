...
const DashboardHome: React.FC<DashboardHomeProps> = ({ clients, properties, visits, marketingLogs, buyers }) => {
  ...
  const filteredOptions = useMemo(() => {
      ...
      return properties.filter(p => 
        ...
        p.address.neighborhood.toLowerCase().includes(term) ||
  ...
  const kpis = useMemo(() => {
      if (isGlobal) {
          ...
          const weeklyVisits = filteredVisits.filter(v => new Date(v.date) >= startOfWeek).length;
  ...
  return (
    <div className="space-y-8 pb-10">
                                ...
                                >
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <div className="flex justify-between items-center mb-0.5">
                                            ...
                                            <span className={`text-[9px] uppercase font-bold px-1.5 py-0.5 rounded ml-2 whitespace-nowrap ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* FUNNEL CHART */}
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 shadow-sm border border-slate-100 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 animate-fade-in-up flex flex-col" style={{ animationDelay: '0.2s' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fade-in-up" style={{ animationDelay: '0.25s' }}>
