...
const Dashboard: React.FC<DashboardProps> = ({ clients, properties, onNewClient, onEditClient, onAssignProperty, onEditProperty }) => {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      {/* Main Table / List */}
      <div className="bg-white/60 backdrop-blur-xl border border-white rounded-3xl overflow-hidden shadow-xl animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                  ...
                  return (
                    <React.Fragment key={client.id}>
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold border transition-transform duration-300 hover:scale-105 ${
                             client.profileType === 'investor' ? 'bg-[#AA895F]/10 text-[#AA895F] border-[#AA895F]/20' :
