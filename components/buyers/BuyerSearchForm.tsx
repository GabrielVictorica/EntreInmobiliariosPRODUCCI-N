                ...
                <div className="flex items-center space-x-2 bg-white/50 p-1.5 rounded-xl border border-[#364649]/10">
                    {(['activo', 'pausa', 'concretado', 'caido'] as SearchStatus[]).map((s) => (
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-all ${status === s ? getStatusColor(s) + ' shadow-sm scale-105' : 'text-[#364649]/40 hover:bg-white/50'
                                }`}
                        >
                            {s}
                        </button>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {['departamento', 'casa', 'ph', 'terreno', 'local', 'oficina'].map((t) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-lg text-xs font-bold uppercase border transition-all ${propertyTypes.includes(t as PropertyType)
